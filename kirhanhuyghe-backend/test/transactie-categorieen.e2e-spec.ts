...
describe('Transactie Categorieen (e2e)', () => {
  ...
  it('GET /api/transactie-categorieen should return 404 or 200 (controller may be empty)', async () => {
    const res = await request(app.getHttpServer())
      .get('/api/transactie-categorieen')
