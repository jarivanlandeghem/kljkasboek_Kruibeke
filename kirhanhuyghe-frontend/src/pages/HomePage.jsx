import { Link } from 'react-router'; // Of 'react-router-dom' afhankelijk van je versie
...
export default function HomePage() {
  ...
  // 👇 Check of de gebruiker bestaat EN de rol 'admin' heeft
  ...
  return (
    <AlgemeneLayout image={kidsPlaying}>
      <div className="flex flex-col gap-4 items-center bg-white">
        ...
        {/* 👇 Alleen tonen als isAdmin true is */}
        {isAdmin && (
          <Link to='/register'>
            <ActionButton 
