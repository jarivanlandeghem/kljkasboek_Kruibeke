describe('Aanwezigheden - Mijn Agenda flows', () => {
  beforeEach(() => {
    ...
    cy.intercept('GET', 'http://localhost:3000/api/users/me', { statusCode: 200, body: { userid: 2, voornaam: 'Test', roles: ['user'] } }).as('me');
  });

  it('Wijzigt status naar aanwezig (geen validatie errors)', () => {
    const events = [
      { evenementID: 100, naam: 'Mijn Test Event', datum: '2025-12-01', startuur: '10:00', einduur: '12:00', type: 'ACTIVITEIT' }
    ];
    ...
    cy.intercept('GET', 'http://localhost:3000/api/aanwezigheden', { statusCode: 200, body: attendances }).as('getAttendances');
    ...
    cy.intercept('PATCH', 'http://localhost:3000/api/aanwezigheden/*', (req) => {
  ...
  it('Wijzigt naar Aangepast (PARTIAL) and validates inputs', () => {
    const events = [
      { evenementID: 101, naam: 'Aangepast Event', datum: '2025-12-02', startuur: '09:00', einduur: '11:00', type: 'ACTIVITEIT' }
    ];
    ...
    cy.intercept('GET', 'http://localhost:3000/api/aanwezigheden', { statusCode: 200, body: attendances }).as('getAttendances2');
  ...
  it('Wijzigt naar Afwezig (ABSENT) and validates reason', () => {
    const events = [
      { evenementID: 102, naam: 'Afwezig Event', datum: '2025-12-03', startuur: '14:00', einduur: '16:00', type: 'ACTIVITEIT' }
    ];
    const attendances = [
    ...
    cy.intercept('GET', 'http://localhost:3000/api/aanwezigheden', { statusCode: 200, body: attendances }).as('getAttendances3');
